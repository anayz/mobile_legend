  ...
  render(){
    return(
      <View style={nbStyles.subtitle}>
          <Text style={{fontSize: 25, marginTop:20, marginBottom: 50, textAlign: 'center', color: 'white', fontWeight : 'bold'}}>
            Heroes
          </Text>

          <Image
           style={{alignSelf: 'center', width: 320, height:160, marginBottom: 10, marginTop:10, }}
            source={{uri: 'https://assets.jalantikus.com/assets/cache/516/290/userfiles/2018/05/17/karina-d741d.jpeg'}}
          />

          <Image
           style={{alignSelf: 'center', width: 320, height:160, marginBottom: 200, marginTop:5, }}
